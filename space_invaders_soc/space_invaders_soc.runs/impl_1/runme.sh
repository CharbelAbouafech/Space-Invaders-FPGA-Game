...
HD_PWD='C:/Users/Charbel/Documents/ECE_520/space_invaders_soc/space_invaders_soc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log space_invaders_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source space_invaders_bd_wrapper.tcl -notrace
