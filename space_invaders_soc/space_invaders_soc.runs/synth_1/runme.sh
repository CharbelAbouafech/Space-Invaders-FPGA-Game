...
HD_PWD='C:/Users/Charbel/Documents/ECE_520/space_invaders_soc/space_invaders_soc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log space_invaders_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source space_invaders_bd_wrapper.tcl
