...
ISEStep( "vivado",
         "-log space_invaders_bd_space_invaders_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source space_invaders_bd_space_invaders_ip_0_0.tcl" );
