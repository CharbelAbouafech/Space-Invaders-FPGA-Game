...
HD_PWD='C:/Users/Charbel/Documents/ECE_520/space_invaders_soc/space_invaders_soc.runs/space_invaders_bd_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log space_invaders_bd_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source space_invaders_bd_auto_pc_0.tcl
